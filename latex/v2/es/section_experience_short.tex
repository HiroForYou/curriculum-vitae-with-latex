...
\textbf{Presente} & Brindé servicios de consultoría para empresas del sector bebidas en toda LATAM, diseñando plataformas de datos escalables y sistemas de ML end-to-end. \\
    ...
    & \clientblock{Industrias San Miguel (ISM)}{Industria de Bebidas}{%
      \begin{itemize}
        \item Diseñé y desplegué un asistente de \textbf{RAG} de documentos con \textbf{IA Agéntica} en un sistema \textbf{NVIDIA DGX} on-premises para cumplir con requerimientos estrictos de privacidad de datos.
...
\experience
  ...
  {Noviembre 2024} {
    \begin{itemize}
      ...
      \item Desarrollé proyectos piloto de machine learning para pronóstico de precios de productos y un modelo predictivo de churn de clientes usando técnicas avanzadas de series de tiempo (Python, PyTorch, GCP), lo que mejoró la precisión en la gestión de inventario y permitió anticipar patrones de abandono, optimizando la retención de clientes.
    \end{itemize}
  }
...
\experience
  ...
  {Marzo 2025} {
    \begin{itemize}
      \item Lideré la arquitectura y entrega de un \textbf{sistema multi-agente en producción} (agente de OCR \(\to\) agente de Validación, handoff secuencial, orquestado con \textbf{LangGraph}) para el procesamiento automatizado de pólizas de seguro, combinando Hugging Face Inference Endpoints, modelos personalizados en PyTorch, una \textbf{VectorDB} para contexto de referencia, y APIs de tools personalizadas en Node.js para validar los datos extraídos contra reglas de negocio.
  ...
  {{Sistemas Multi-Agente}, LangGraph, VectorDB, {AWS (EC2, DynamoDB, Bedrock, CloudWatch)}, Guardrails, RAGs, FastAPI, Ollama, DeepSeek, {Hugging Face}, OCR, Next.js, LLMs, OpenAI}
...
\experience
  ...
  {Octubre 2023} {
    \begin{itemize}
      \item Lideré el desarrollo de Chatbots para WhatsApp, Messenger e Instagram basados en modelos avanzados como Chat-GPT, mejorando la comprensión y las respuestas naturales. También usé modelos de Computer Vision (para tareas de OCR), modelos de generación de imágenes y modelos de reconocimiento de voz.
...
\emptySeparator
\experience
  {2020}{Ingeniero de Computer Vision Freelance}{Luz del Sur}{Lima, PE}
  {Remoto}{Freelance}
  {2021} {
    \begin{itemize}
      \item Construí un modelo de Deep Learning para el reconocimiento automático de dígitos y letras en medidores eléctricos para esta empresa peruana de servicio eléctrico, como parte de un flujo de automatización de lectura de medidores basado en OCR que redujo el trabajo manual de digitación.
    \end{itemize}
  }
